...
class Classifier(nn.Module):
	def __init__(self, config,  d_model=250, n_spks=600, dropout=0.1):
		super().__init__()
		...
		#	d_model=d_model, dim_feedforward=256, nhead=6
		#)
...
def main(
	...
	model = Classifier(model_config, n_spks=speaker_num).to(device)
